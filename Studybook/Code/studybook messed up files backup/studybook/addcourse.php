...
if (isset($_POST['course_number']) && isset($_POST['subject']) && isset($_POST['section']) ){
	...
	if (!is_numeric($_POST['section']) || empty($_POST['section'])){
		echo ("<h2>Please Enter A Valid Section Number</h2>");
		?>
		<form action="home.php" method="POST">
		<input type="submit" name="Back" value="Back">
		</form>
		...
		$course_number = $course_number."-".$section;
